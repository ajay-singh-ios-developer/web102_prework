...
const displayStr = `
    A total of ${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfunded} game${numUnfunded == 1 ? "" : "s"} remain${numUnfunded != 1 ? "" : "s"} unfunded. We need your help to fund these amazing games!
`;

// create a new DOM element containing the template string and append it to the description container
const newEl = document.createElement("p");
newEl.innerHTML = displayStr;
descriptionContainer.appendChild(newEl);
...
// console.log(topGame, runnerUp, otherGames);
